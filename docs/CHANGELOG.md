...
* feat(semantics): check semantics release
BREAKING CHANGE: test ([`cfcf39b`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/cfcf39ba558d5efcf11880e632c02536017ef1f6))

### Unknown

* Merge remote-tracking branch &#39;origin/main&#39; ([`6085619`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6085619b27fb51e1f800dee08b4c4a82f47536f8))
...
Automatically generated by python-semantic-release ([`af1daa0`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/af1daa05a6c06c19beb9259c10f04a1e6bccdbce))
...
* feat(entities): check semantics release ([`f42d76b`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/f42d76b554fe835c169ba38e20fba8ed41189cf1))
...
* feat(entities): check semantics release ([`a1f98e7`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a1f98e7abf4c4e64df975649abf28942fb207163))
...
* feat(entities): check semantics release ([`b0ecc75`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b0ecc75f3368e6a7a575ceef2ae8be7cbc84cd79))
...
* feat(entities)!: check semantics release ([`6562932`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/656293295d0c7b54913e567009488047fc36b86a))
...
* release!: check semantics release ([`7e810d8`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/7e810d85741ae4cb05c67e8a09cc525208ec933c))
...
* refactor: restrict post methods from viewer role ([`ea039a9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/ea039a915d9ebafcd15b1538afb0616148074e01))
...
Automatically generated by python-semantic-release ([`7e21021`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/7e21021012508d5345000d7787540c0696c4acda))

* 1.1.0

Automatically generated by python-semantic-release ([`1e60dc9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1e60dc993a28d1e60483b7c130bbafffa94dd702))
...
* review changes ([`3201367`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3201367a06f5fd353d44090c846e22bae7948e3d))
...
* chore: fiware service exception from filip (#86) ([`a899f93`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a899f93deebc5c447ee5bc2a9deba32bbf0df9c0))
...
* feat: batch deletion for devices and service groups ([`1e55a4d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1e55a4d38da3e41596f1cde29db1773821dd5cef))
...
* fix: update frontend frameworks (#61) ([`220f26c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/220f26c02017853f5943bb8baed3275b4ea6f7ad))
...
Automatically generated by python-semantic-release ([`15979e2`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/15979e2592bb1876fe78feee7c81a1ebc2f8d764))
...
* fix handleClick ([`6e3a521`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6e3a52181a02a724fd9431cd21fef3295acd7eea))
...
* Adjustment of color scheme ([`e4d904e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e4d904e65fbc6e6350d52f6706c67cc33dc364de))
...
-integration of he entity tabel. No Styling, still default layout ([`6f89454`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6f894547e95fffbfbf24d5b3bdfc6706256e506f))
...
Implement service group ([`29d6c50`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/29d6c50919fce33d9913cff453b8506c39dfe02f))
...
* chore: cleanup requirements and settings ([`237f6af`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/237f6afcca2253c412c582da3a70179dad2149e1))
...
* chore: non-selection handling ([`7663907`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/7663907c9bd0283e0b48383533310c8fcd43e6a6))
...
* chore: include attributes in table ([`26b3ee4`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/26b3ee4fec8bbf9bc4fae4d4467c3f6106f70091))
...
* chore: mini change ([`b117910`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b11791008f54ce38018d98a5cd8e30dcf42ca70f))
...
* fix: included delete entity ([`f6388eb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/f6388ebc96ffc11d81fcaf054ce2aac7e2d81528))

* fix: old attribute types ([`2d465ea`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/2d465ea148b522dd748280124867633e2f3cb98a))

* fix: included delete devices ([`0f41da4`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/0f41da464c6924e1832104bb845a76ee72380c20))

* fix: minor bug fix ([`3b5543a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3b5543a929c00b8c8b69f522fa1624ecd44ee8ed))

* fix: js load bug fix ([`f05d883`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/f05d883c8ac5d93151876ec5eb27c8efd3750182))

* fix: fixed bug ([`b548a63`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b548a63c7a90999d3b401c83cc7c3e3430cf09f8))

* fix: include actual request ([`957b19f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/957b19f6b542b58d24cf09d36dab48e1b2dae1c8))

* fix: entity form on error ([`efc3844`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/efc3844006fe08708568a047c0a289ce2f110498))

* fix: move script to template ([`3f28348`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3f283482d51a22aedbf5912df6c3ae7a81afd18a))

* fix: wrong total forms number ([`86f6dac`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/86f6dac7923a46145424017628854c22a49255dd))

* fix: object_id can be left empty ([`30486be`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/30486be57f00c84c2ce1026ec4526defe75211df))

* fix: empty form set in edit mode ([`b0752cd`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b0752cd61af411458539a2ef4169d97f9cd499c9))

* fix: fixed modal title ([`e6b56e9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e6b56e949ef3174aa99cb2bedfcf4dd1b2918ddf))

* fix: loki host name slow the programm down ([`ac66f61`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/ac66f61a83f86a45944823c283979f5119352920))

* fix: syntext ([`4010792`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/40107924b6fe10baf979b7685251c16bcac287f6))

* fix: re-include loki settings ([`fed076a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/fed076abf5539fe2829a9d629b6d83a1a27db5e7))

* fix: table to include both id and type ([`657da3d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/657da3dfb7ca614523481c81d8bc7d2906aec187))

* fix: maxlength fix and entity type editable ([`d336dcb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/d336dcba586a04816c4c64741dee8f78ee1aa87e))

* fix: fixed edit button ([`25f4f9d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/25f4f9dca755d128a1a866342f0571e19769e53b))

* fix: change to filip util subscription function ([`0044ddb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/0044ddb11c49f4ff5e33ab36c395959458d7728f))

* fix: correct widget field type ([`e22b8a9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e22b8a90011acf7034e076d3895ea0c5b388c417))

* fix: conditional accordion form render ([`019fdfc`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/019fdfc6a0d665a866c40c0e97425da4a6250adb))

* fix: project card alignment with description tooltip ([`de53020`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/de53020f4335d89e77c70d844cfb6001b47c69ee))

* fix: remove form tag from internal forms ([`ae7a5d3`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/ae7a5d3007f318bcbe9f45995afaa0b71dda1f1d))

* fix: use form helper so that all forms are submitted ([`15e8116`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/15e81165d0a843bfde43bd4dc1d3b5a03491d997))

* fix: clone empty form instead of first form ([`d6e508c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/d6e508c2462583df2786dc4503e74e8797bc4fa4))

* fix: align example ([`0bb8bbb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/0bb8bbbe2366f27e3147d2ba284f8056eb7878a2))

* fix: remove checkboxes for remove ([`98c9bf2`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/98c9bf28c179781be85f2c423d9ba9c0ed05cac4))

* fix: js console error ([`93f9315`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/93f9315f68cadb507e3255beeee31a1bd5ae966b))

### Unknown

* Create PR for #47 ([`4f1a3ef`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/4f1a3ef99dbc4f2e7f376981b393f8297ebe0530))

* Update ROADMAP.md

add link ([`74fa959`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/74fa959a58f8f832927160968ab1d6bf54bd848a))

* Merge pull request #41 from N5GEH/40-update-tooltip-messages

update tooltip messages ([`1ef4850`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1ef4850cf64ca9fa938c6e7f00be3c7836bdb43b))

* Merge pull request #42 from N5GEH/36-health-status-on-project

health status on project ([`85c7117`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/85c7117fa930242d42c068f8b0845135c80298e9))

* Merge branch &#39;development&#39; into 36-health-status-on-project ([`bae54aa`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/bae54aae4bae84d3327d1f15b9f3f0ae225921be))

* Merge branch &#39;development&#39; into 40-update-tooltip-messages ([`3c7d522`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3c7d522cdae947c7aab06f248fe429ce3db4436b))

* Merge remote-tracking branch &#39;origin/43-roadmap&#39; into 43-roadmap ([`da1f963`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/da1f963a67b4a74f2be2cfdc705dc94dbb04db22))

* Create PR for #43 ([`30939c1`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/30939c1cad136cab818b416878fa3e787309df02))

* Merge pull request #16 from N5GEH/15-work-on-devices-app

work on devices app ([`3a0a907`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3a0a9074450ea0a4b818f2c10df3908cee078f59))

* Merge branch &#39;development&#39; into 15-work-on-devices-app ([`329178f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/329178fc7ec406f5c677c4a79bdf319dd2fdae64))

* Create PR for #36 ([`b3503f1`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b3503f19fdc4c889bb58574db7e25a5de6f129a9))

* Create PR for #40 ([`b748f04`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b748f048301563953f7d9988b894858e8eefaeaa))

* Create PR for #37 ([`6b7f8b5`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6b7f8b59dfd4af410802662a28b56f24a102d502))

* Merge pull request #38 from N5GEH/35-on-off-application-based-on-env

on-off application based on env ([`35ef6b6`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/35ef6b62338b496901ac11b3e8b4517009488214))

* Merge branch &#39;development&#39; into 15-work-on-devices-app ([`eee4281`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/eee4281bdfa0818fd92660db35ee941f19566cd0))

* Create PR for #35 ([`d6281ab`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/d6281abd29a6c4e8e8d0cb1b8c632a5c7f439cf7))

* Merge pull request #25 from N5GEH/24-work-on-entities-app

work on entities app ([`a7cbcd7`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a7cbcd7780dbe91ac7ba3d4c95eee79440673875))

* Merge branch &#39;development&#39; into 24-work-on-entities-app ([`b7dc3ec`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b7dc3ec6fca25aeca892d057e70dc61c55552c58))

* Merge branch &#39;24-work-on-entities-app&#39; into 15-work-on-devices-app ([`8c0ef77`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/8c0ef775e81fdafd8ffa189eec2d499c59146cbc))

* Merge branch &#39;development&#39; into 15-work-on-devices-app ([`23b96e8`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/23b96e880c1287372f9c8bf0cc57309275950982))

* Merge branch &#39;24-work-on-entities-app&#39; into 15-work-on-devices-app ([`a3b5994`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a3b5994287ac4dc514738642b1be4468ea9bf943))

* Merge pull request #34 from N5GEH/33-dictionary-type-settings-in-pydantic

Dictionary type settings in pydantic ([`a970a36`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a970a362c7450f70580751860a7f95f0ff4d0988))

* Merge branch &#39;24-work-on-entities-app&#39; into 15-work-on-devices-app ([`5c0f4c4`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/5c0f4c4edf71011fe0445e6425f6e693c6bd97d9))

* Create PR for #33 ([`cf2ec3e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/cf2ec3e645ab81dd42c4919d661238ac9428be16))

* Merge branch &#39;24-work-on-entities-app&#39; into 15-work-on-devices-app ([`6ab042a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6ab042a871940ca5a49b0cae0b5ae06465df5663))

* Merge branch &#39;development&#39; into 15-work-on-devices-app ([`73b0c1d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/73b0c1d4ae547aac646e821ef546de5c384984a0))

* Merge pull request #32 from N5GEH/31-fix-logging-in-settings

Fix logging in settings ([`cbd0845`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/cbd08451720710803256ed0fef9ab5bcc346cc1b))

* Create PR for #31 ([`1145eeb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1145eeba5f5c8ee508145a2812d6a35a05827b69))

* Merge branch &#39;24-work-on-entities-app&#39; into 15-work-on-devices-app ([`96e4c13`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/96e4c13bfc86f82252f008f1ffb2b768da09041c))

* Merge pull request #30 from N5GEH/29-general-way-to-display-error-message

general way to display error/warning/success message ([`ff34cd2`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/ff34cd2b3fb9ab84a290553ba3da13b9fb230adf))

* Create PR for #29 ([`72cccfd`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/72cccfd9bc7c25090f88c02f31c947bd95315c8f))

* Merge branch &#39;21-implement-accordion-template-for-apps&#39; into 15-work-on-devices-app ([`256e171`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/256e171b8ee69923f628aec747ddfe3ea664a6d6))

* Merge branch &#39;21-implement-accordion-template-for-apps&#39; into 24-work-on-entities-app ([`43f8f1b`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/43f8f1bb5f2c66bd8e3c3390aa232dbdfc34a62e))

* Create PR for #24 ([`35b7743`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/35b77437f6c2c2016f9d9e7a2e086cc418d23ba6))

* Merge branch &#39;15-work-on-devices-app&#39; of https://github.com/N5GEH/n5geh.tools.entirety2 into 15-work-on-devices-app ([`eef330d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/eef330d0291df009faa2377047da5b290df09453))

* Create PR for #15 ([`3433f04`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3433f04989c47a6763a832a1cb25e647ba484ecb))

* Create PR for #15 ([`5173353`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/51733537d57fb7d03d57f796f5181266d29d3ac1))

* Create PR for #15 ([`5d4c7b8`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/5d4c7b83845736d28d8617ec1a3fb2d4e5ba0a6b))

* Create PR for #15 ([`32a1122`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/32a1122330d450fbd0d33dced798e4708c93d03f))

* Merge branch &#39;15-work-on-devices-app&#39; of https://github.com/N5GEH/n5geh.tools.entirety2 into 15-work-on-devices-app ([`a2e17c7`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a2e17c7c12ca209aa4151d3dd4502047b4fa5f55))

* Create PR for #15 ([`6a4d612`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6a4d6126083e8872da320b08236d7e56b9886509))

* Create PR for #15 ([`5a37862`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/5a37862e7a0d545feff351212eb7538fddcbe828))

* Merge pull request #10 from N5GEH/9-implement-logging-for-application

implement logging for application ([`6216394`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/62163942c4b1aba5e8aec52a91836f27f363d1a7))

* Merge branch &#39;main&#39; into 9-implement-logging-for-application ([`116eadd`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/116eadd98b0727c27f73cab5e51b8b9d71b6f881))

* Merge branch &#39;15-work-on-devices-app&#39; of https://github.com/N5GEH/n5geh.tools.entirety2 into 15-work-on-devices-app ([`110dcc6`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/110dcc646b10408255013c959c3248f7ae4135b1))

* Create PR for #21 ([`cbaea5d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/cbaea5d0d98a49acc53d3d43d2513426a1e853d4))

* Create PR for #15 ([`2a4336a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/2a4336ad77c2964aef63903ede929f51665ffb86))
...
* chore: example logging in view ([`48acb67`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/48acb6756c3037a10a2e3e4cebb3b3e93b2290be))

* chore: pass all logs to loki ([`77b3f23`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/77b3f23d87476fd3f00fe43dc897630fb2bebcf7))

* chore: template view based on user and list class for projects ([`9166f4e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/9166f4ed19a444bb89199ff8422ddd807852ff38))

* chore: project mixins ([`c305e10`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/c305e10c658696ec0f6ad7fb8ea39c35c0fdc7f0))

### Fix

* fix: fixed card grid to auto ([`72e2c71`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/72e2c714a5a4022ab002d1216e0b32245a7bd602))

* fix: delete unused view structure ([`d1ed9c8`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/d1ed9c8822c3670c413b3580ee2e733cd2278ec2))

* fix: project context mixin ([`e1d22c0`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e1d22c0774c35357777ec16568305ba55efcf83c))

* fix: re-activated alarming url ([`98c8f43`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/98c8f4300c6bb81270fda6134fd0980c97bf20da))

### Unknown

* Merge pull request #18 from N5GEH/17-auth-in-projects-app

auth in projects app ([`4e20613`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/4e20613c4485db89a34a97efafc0c1f277a45938))
...
* chore: added loki logging ([`3a01b1c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3a01b1c8b6f516b411e6bb05224a63172ecde632))

### Documentation

* docs: update requirements.txt ([`746bc0a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/746bc0acc5d5580b8bf3b065be1c20fc93cf91e1))

### Fix

* fix: remove unused code ([`01d4ca2`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/01d4ca2a13ccd230c6be710ff34cb240eb375fb8))

* fix: corrected timezone ([`1b4c1ca`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1b4c1ca6cb218f056b1a247b366fa84717bc7d1a))

### Refactor

* refactor: style using boostrap classes instead of custom style ([`275bd41`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/275bd414dd3c23fd35fea6cc3353b4f17475051b))

### Unknown

* Create PR for #17 ([`0f0e6f1`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/0f0e6f19ef04b20b0992dd5bf3deb6be4936f403))

* Merge pull request #4 from N5GEH/3-Work-on-projects-application

Work on projects application ([`8749ea0`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/8749ea0b9f4fd3006ca06ebe44ba91170d4acb59))

* Create PR for #15 ([`fc3c64c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/fc3c64c20fb7e9a25576667d30bd214a40fe1a40))
...
* chore: fix typo ([`f0ec3ba`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/f0ec3bad5c2db157af6e55aebbbb83acc07838fc))

* chore: exclude js/css frameworks from language detection ([`11e8404`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/11e84045048d9ae4285d092446ca2702815a0eba))

* chore: use lowercase branch names ([`1ff5aca`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1ff5acac1ded69eeef6a8b88d2a5475c79003dc8))

* chore: exclude js/css frameworks from language detection ([`dc46507`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/dc46507c3240dda03f2c93a8150ff3b964d776bb))

### Fix

* fix: remove extra line ([`31c9e5c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/31c9e5caba5832ce57579600d510bf2e95bc9cc4))

* fix: database setting ([`bb4750c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/bb4750c4ca31164cf216a9b73e68a2ad0745763f))

* fix: use oidc auth in django admin ([`d4d862d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/d4d862de39c808cb8b8a4d2a5744aca1679423c6))

* fix: project reference ([`bb8f59e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/bb8f59e5a84eb71d6838437b3c86fc7a9057e61c))

* fix: project card alignment ([`4c93b1c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/4c93b1c1fad0a2a70fee4130699c37df85d633a2))

### Refactor

* refactor: restructure examples app ([`19de04e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/19de04effb3689f6dbae2f61f080d62ecfb8f95b))

### Unknown

* Merge pull request #12 from N5GEH/11-redirect-admin-to-oidc-provider

redirect admin to oidc provider ([`49f88e7`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/49f88e7002db8bd7dc1f5c5b7896716e1d3fffa0))

* Merge remote-tracking branch &#39;origin/main&#39; into 9-implement-logging-for-application ([`ab45244`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/ab452449659100b37db1c3b8ad9d394933870459))
...
#	app/Entirety/templates/sidebar.html ([`d2d1c0f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/d2d1c0f744949d645f160d29960c34c894df2958))

* Create PR for #11 ([`95d919a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/95d919ae59de021b70583dc5e1561d13eb50909a))

* Merge pull request #8 from N5GEH/7-Hackathon_1

Hackathon_1 ([`3a1f5c0`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3a1f5c0520366a8cf0230db7b0386d97701f8439))

* Merge branch &#39;7-Hackathon_1&#39; of https://github.com/N5GEH/n5geh.tools.entirety2 into 7-Hackathon_1 ([`e4ba278`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e4ba2787f8567eb6275742e38a0bd44565152549))

* Create PR for #7 ([`6621a70`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/6621a700ba53eb3eb1cb5a2708adead10e2fb60f))
...
* chore: delete modal and search bar styling ([`80c738f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/80c738f6706185fa4ae46aa162bf514adcaff039))

* chore: made project name unique ([`8fea285`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/8fea285eb8390f413e3620f5eb741890ea076691))

* chore: add alarming app for testing purposes ([`1d166de`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1d166de533ed73f73059d00cc682c266c75a80ee))

* chore: add user model meta info to database ([`df4fcbb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/df4fcbb9cfeeb53854cd7b565c5afc3442219dd2))

* chore: cleanup templates ([`5bd2f78`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/5bd2f7820adb2fe70c47bed60e66ccb2381453e4))

* chore: add super_admin to staff ([`2cb2d1d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/2cb2d1d65501734dccf2e16f3b3430fa0e43aa45))

* chore: clean settings ([`80d5e99`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/80d5e99dbf718236c32dd267c5f731f261e04435))

* chore: fix language code default ([`0bb28b9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/0bb28b90e8838fb813f7c5d2e2f27e0fb0420a59))

* chore: add oidc provider ([`07c4cdb`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/07c4cdb07407807c3860566b33761b05b89aabe0))

### Documentation

* docs: move settings to seperate file ([`09688b9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/09688b909253012788dbabb61bcc247e5818ddb6))

* docs: add changelog and contributing to readme ([`18a2a73`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/18a2a73012117707f60120624d516a0e4f3d1aa8))

* docs: contribution guidelines added ([`953f61a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/953f61a6e77f1099a56b66866ac44ca94e1cfbc3))

* docs: update requirements for image upload ([`8940b96`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/8940b96c20e53dc72408a46b9900392857e229c1))

* docs: add env variable description to readme ([`557e9a6`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/557e9a672f4294fe06b64da0ac0a8e84a81d41e7))

* docs: update requirements ([`3a01011`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/3a010116cd25210a3e375c7e02a91ab10f651cf4))

### Feature

* feat: add custom error pages ([`a84053a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a84053a41948fde9dd9178c7d97a1e55c35dd4f5))

* feat: raise a HTTP 403 if user is not authorized ([`a556bdd`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a556bdd89bae486421ed1894e344a6f061db6282))

* feat: run apps in project context ([`fcc4f0a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/fcc4f0a6a8fd3c8e8da7ceb554a6e039969e1e04))

* feat: projects create and update view with form ([`a7fc8f7`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a7fc8f70ea810099baeddda73d1a8b55750de3a8))

* feat: make sidebar sticky ([`8bd132f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/8bd132fede464380e7f62ac6a9526e8c03e6ef87))

* feat: get authorization parameters from settings ([`7ca3e49`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/7ca3e49e0b75e689d24131c0acd17d1b7cfd8fa9))

* feat: add user profile page ([`4e0f757`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/4e0f757a8b748cb88fc9437a56e3e60105866f6d))

* feat: add basic authorization ([`03ab314`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/03ab3148e3746a1cefd25ea1d292b6fae0e70db0))

* feat: pydantic settings setup ([`c90c031`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/c90c031e5cd85fb1659f6fd984be6259525bd1b9))

* feat: require login for view ([`1151c93`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1151c93ea9074ca17ebb6f695f3c9b5afe594812))

* feat: login/logout implemented ([`c0cd1aa`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/c0cd1aa67662b253cd2a33da7ddfd71168a684da))

* feat: use pydantic settings ([`5499f10`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/5499f10625cc02d77c36de2126b72df09ad78997))

* feat: add user settings to ui template ([`1ba1c29`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1ba1c29c461090f6f2ba20fbd4510b0520d16bc7))

* feat: projects application model view ([`f2d0060`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/f2d0060ce18658f52e8365773a7de841e2c973eb))

### Fix

* fix: show project name after selection ([`a2cd2af`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a2cd2af31c8bab7b704a2e598ecc279ce46074a6))

* fix: remove extra parameter
No need to add form.helper if the FormHelper attribute is named helper (in forms.py) ([`41fa198`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/41fa198a6db9152ded33bd684c976d018177d8e9))

* fix: corrected braces ([`aa402f9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/aa402f92fd85a57b8b6d03981c9d1a2ba81be4b7))

* fix: crispy form settings bootstrap5 ([`6782418`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/678241889b7e0360a1413dfa50d27b25c658df5c))

* fix: scrollbar styling ([`b278c8a`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/b278c8a8ca3bdd7b667aacb139f47323abcc412d))

* fix: set sidebar link active ([`a792b1f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a792b1f6eda3c771ff834c752c9216f4bf8bde96))

* fix: fix requirements and settings ([`1848ca3`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1848ca32b2df9b87515b074fdb8d4f8705f7018c))

### Unknown

* Merge pull request #6 from N5GEH/5-add-oidc-auth

add oidc auth ([`33ed830`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/33ed8307ee78146c8ee334870068edd88d276fec))

* Create PR for #9 ([`32e4df0`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/32e4df0e6a64f830f84cb7f53403823249cb4a1f))

* Create PR for #7 ([`95cc8b9`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/95cc8b98a70136b447dd3d0dc04f88521078ad44))
...
#	app/Entirety/entirety/settings.py
#	app/Entirety/entirety/urls.py
#	app/Entirety/projects/templates/projects/index.html ([`c9c2025`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/c9c2025519afe439e32dbb435667134dc12fbf71))

* Create PR for #5 ([`144408c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/144408cf091ca9a945437ae961f7faf1995f5c04))
...
* chore: fix typo ([`8633ebe`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/8633ebebd09fdf156c0889be132b235ae421d4b8))

* chore: Merge pull request #2 from N5GEH/1-create-base-ui

create base ui ([`a2e34cc`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/a2e34ccca8f4162d37323d0b099c4594279f17fe))

* chore: updated requirements ([`19b5b9d`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/19b5b9db5dd62927fd29f9a119ee07908e157495))

* chore: use crispy forms ([`5179429`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/5179429472cd7059f7bf2942f28c2c087a27ff59))

* chore: modal form as template ([`e393977`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e3939773c2fe85570151723a527ef7f8671fb841))

* chore: add semantic release ([`5508397`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/550839769783bddd548e7616e65a5ec2bc2d8757))

* chore: example url in sidebar ([`173c7de`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/173c7de045d67f3d93d33d6c7f5922cd9e61d0b0))

* chore: use scss ([`c832712`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/c8327122fdebd683e7e1e79bcf9419fefd1fcf93))

* chore: add navbar ([`4fa3bc4`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/4fa3bc46e7883fb904ca8bc6432dc8c2ab91e6bb))

* chore: use local resources ([`e942c3f`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/e942c3f1f1fbf5e9f0957c6bfa854f8d8e16d474))

* chore: base repo setup ([`671f17c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/671f17c1d51cdcdbc699e3136f90edb0d635802c))

### Documentation

* docs: update contact ([`9e52b64`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/9e52b64c98a5684fca05bb5ca251229108b65982))

* docs: add install instructions ([`7c0c1f5`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/7c0c1f50434059af190b70b80e3643619dd7eefe))

### Feature

* feat: add success message toast ([`30acd77`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/30acd77dc0d2e7f6c0744c1fceaf750c21d76d4f))

* feat: dialog template with example ([`02b485b`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/02b485b1f28650b03bea0e399d0a2950ff1703c5))

* feat: collapsible sidebar ([`c7fefb2`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/c7fefb2c2b67f033db534005d294d7c3a70a015b))

* feat: create base app structure ([`366bf73`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/366bf7332a2eddccada6f28aa16af34a7ab3191a))

### Fix

* fix: show sidebar tooltips only on small screen ([`24cb298`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/24cb29812284a09426dfea079b72b86cfdd1c4f7))

* fix: fix sidebar adjustment ([`db8081c`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/db8081cd504629bca3c7644267837a336e103f53))

* fix: fix admin page css ([`646808e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/646808efbbd603e273ca8351532770d49a61bd16))

### Unknown

* Merge remote-tracking branch &#39;origin/1-create-base-ui&#39; into 3-Work-on-projects-application ([`270c67e`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/270c67e27cde667fc6dc3e1b8b590d0c997d46cc))

* Create PR for #3 ([`1cc1cdc`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/1cc1cdc9ff916ba6e65db2a17bc192950db3c80e))

* Create PR for #1 ([`dfe3dfe`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/dfe3dfe6a9e3685f33bc1d174b61611e7dc0ff35))

* Initial commit ([`9871a06`](https://github.com/sbanoeon/n5geh.tools.entirety/commit/9871a06e91e83fb062f45f465484682d33b2bd42))
